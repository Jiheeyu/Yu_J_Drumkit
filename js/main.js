(() => {
  ...
  function playSound(event) {
    ...
    audioElement.play(); // round barckets means this is a method - a built-in fuction

    key.classList.add('playing');
  }

    // add an event listener to the window and capture all the key board key presses
